...
\end{itemize}
\subsection{Forma d'onda APR4 q09}
\begin{table}[H]
	\centering
	\begin{tabular}{cccccc}
		...
		\midrule
		214.1	&71.9	&0.94	&0.1	&1.8	&19.5	\\
		\bottomrule
	\end{tabular}
	\vspace{-5pt}
	\caption{Principali coefficienti per la classificazione del segnale}
	\label{tab:coeff_apr4}
	\vspace{-10pt}
\end{table}
\begin{figure}[H]
	\vspace{-20pt}
...
\begin{figure}[H]
	...
	{\includegraphics[width=.318125\textwidth]{figures/Capitolo_3/APR4_q09/L1_wf_white_inj_rec.png}} \quad
	\subfloat[][\emph{Dominio delle frequenze}]
	{\includegraphics[width=.318125\textwidth]{figures/Capitolo_3/APR4_q09/L1_wf_white_inj_rec_fft.png}}
	\vspace{-5pt}
	\caption{Strain per }
